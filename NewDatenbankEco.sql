...
CREATE TABLE `tbl_massnahme` (
  ...
  `massnahme_emissionsfaktor` decimal(10,10) unsigned DEFAULT NULL,
  `massnahme_absoluteeinsaprung` decimal(10,10) unsigned DEFAULT NULL,
  `massnahme_co2einsparung` decimal(10,10) unsigned DEFAULT NULL,
...
CREATE TABLE `tbl_rechnung` (
  ...
  `rechnung_verbrauchswert` decimal(10,10) unsigned NOT NULL,
  `rechnung_emissionsfaktor` decimal(10,10) unsigned DEFAULT NULL,
...
CREATE TABLE `tbl_umsatz` (
  ...
  `umsatz_wert` decimal(10,10) unsigned NOT NULL,
...
-- Dump completed on 2019-12-07 18:16:19
